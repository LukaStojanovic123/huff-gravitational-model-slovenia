...
def main():
    ...
    parser.add_argument("--force", action="store_true",
                         help="Recompute even if huff_AHP_summary.csv already exists.")
    ...
    print("No existing huff_AHP_summary.csv found — running full computation.")
    print()
    ...
    print("Checking for cached distance matrix...")
    ...
    print("Computing AHP Huff probabilities...")
